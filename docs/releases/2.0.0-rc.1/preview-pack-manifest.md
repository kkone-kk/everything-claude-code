...
- ECC Tools billing/product readiness evidence, the local/internal announcement
  bearer-token path, and a live selected-target announcement gate pass before any
